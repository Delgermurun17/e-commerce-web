...
export default function Page() {
    ...
    async function deleteProduct(id: string) {
        await fetch(`https://e-commerce-service-lowygdfni-delgermuruns-projects-8a2d67b5.vercel.app/products/${id}`,
            {
                method: 'DELETE'
            })
            .then(() => getProducts())
    ...
    function getProductsFilterByPrice() {
        fetch(`https://e-commerce-service-lowygdfni-delgermuruns-projects-8a2d67b5.vercel.app/products?price=${filterByPrice}&&cat=${filterByCategory}`)
            .then(res => res.json())
            .then(data => setProducts(data))
    }
